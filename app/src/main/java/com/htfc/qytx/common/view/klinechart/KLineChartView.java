...
import com.htfc.qytx.common.view.klinechart.draw.KDJDraw;
import com.htfc.qytx.common.view.klinechart.draw.MACDDraw;
import com.htfc.qytx.common.view.klinechart.draw.MainDraw;
import com.htfc.qytx.common.view.klinechart.draw.RSIDraw;
import com.htfc.qytx.common.view.klinechart.draw.VolumeDraw;
import com.htfc.qytx.common.view.klinechart.draw.WRDraw;
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        if (array != null) {
            try {
                ...
                setSelectedYLineColor(Color.parseColor("#999999"));
                setSelectedYLineWidth(getDimension(R.dimen.chart_line_width));
                ...
                setGridXLineColor(array.getColor(R.styleable.KLineChartView_kc_grid_line_color, getColor(R.color.chart_grid_line)));
                //macd
